...
With limited deadline, I would like to put efforts on text processing more than scraping.
By feedparser, it structurize the xml into a way easier to read (dictionary based).
After getting feeds and it's structurized dictionary format, extract the description field,
then use beautifulsoup to extract words from dirty string with a lot of html tags.
